...
class SequenceAlignment:
    ...
    def __init__( self, A, B ):
        ...
        #print_matrix( S, x="Hello", y="Hello" )

        self.compute_f_matrix()
        #print_matrix( F, x="Hello", y="Hello" )
        ...
        for i in range( self.nA ):
            for j in range( self.nB ):
                ...
                if cA == cB: # Exact
                    ...
                    penalty = self.penalties["mismatch_nonprintable"]
    ...
    def print_matrix( m, y="", x="" ):
        print( " " + " ".join(x) )
        for i, row in enumerate( m ):
            label = y[i - 1] + " " if y and i > 0 else ""
...
def main():
    ...
    seq = SequenceAlignment( "Hello", "H3dllo" )
    print( seq )
